...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20220211_kingleaks_7ae75e3d39d912773381_20220211084602_archive.zip';
    const ARCHIVE_SIZE       = '359572745';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '7ae75e3-11084602';
    const VERSION            = '3.8.8';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.8==');
        $this->log('----------------------------------------------------');
